...
IMAGETYPES = ['Other', 'File Icon', 'Other File Icon', 'Cover (Front)',
              ...
              'Lead artist', 'Artist', 'Conductor', 'Band', 'Composer',
              'Lyricist',
...
TEXT_FIELDS = ['album', 'albumartist', 'albumsortorder', 'arranger',
               ...
               'bpm', 'composer', 'conductor', 'copyright', 'date',
               'discnumber',
               ...
               'lyricist', 'mediatype', 'mood', 'organization',
               'originalalbum',
               'originalartist', 'originalyear', 'peformersortorder',
               'producednotice',
               'radioowner', 'radiostationname', 'recordingdates',
               'setsubtitle',
